...
#define OFFSET_PLAYER_INVISIBILITY				0x2C
...
#define OFFSET_VEHICLE_BOOST_TOGGLE	                0x320			//Opressor Toggle
#define OFFSET_VEHICLE_BOOST_RECHARGE_VALUE	        0x31A			//Opressor Recharge val 
