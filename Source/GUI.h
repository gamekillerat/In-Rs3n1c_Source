...
namespace GUI {
	...
	bool Toggle(const char* options, bool& b00l, char* text);
	...
	bool ToggleInt(const char* option, bool&b00l, int&_int, int min, int max);
	bool ToggleInt(const char* option, bool&b00l, int& _int, int min, int max, int step);
	bool ToggleInt(const char* option, bool&b00l, int&_int, int min, int max, char* text, int step);
	bool ToggleInt(const char* option, bool&b00l, int&_int, int min, int max, char* text, int step, std::function<void()> function);
	void VehPix(char* _where, char* called, char* vehname); //I'm gay yellow snowman, want to fuck???
	...
	bool textbelowmenu(const char* Text);
	void End();
}